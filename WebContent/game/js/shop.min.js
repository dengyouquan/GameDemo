...
function(t, e, a, n) {
    ...
    function i(e, a) {
        ...
        //
        this.userid = this.element.find(".userid")[0].innerHTML,
        this._defaults = s,
        this._name = r,
        //
        console.log("shop.min:")
    ...
    t.extend(i.prototype, {
        ...
        checkout: function() {
            ...
            i.attr("action", "http://localhost:8080/Hungry3.2/buy"),
            i.attr("method", "post"),
            //
            i.attr("onSubmit", "return check()"),
            i.attr("target", "_self");
            ...
            a.cart.find("li").each(function(e) {
                ...
                u = {
                    name: t("<input />", {
                        type: "hidden",
                        name: r.name + "_" + (e + 1),
                        value: s+":"+a.cart.find("li").length+":"+a.userid
                    }),
                    amount: t("<input />", {
                        type: "hidden",
                        name: r.amount + "_" + (e + 1),
